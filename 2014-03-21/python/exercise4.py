...
scala=T([1,2,3])([10,9,-1])(scala)

# seminterrato

x_seminterrato = QUOTE([-0.4,18.4])
y_seminterrato = QUOTE([-0.4,18.4])
seminterrato = INSR(PROD)([x_seminterrato,y_seminterrato,QUOTE([0.6,-1.4,0.6])])
seminterrato = T(3)(-1)(seminterrato)
x_pilastri3 = QUOTE([-0.4,0.4,-0.4,-4.8] * 4)
y_pilastri3 = QUOTE([-0.4,0.4,-0.4,-4.8] * 4)
pilastri3 = INSR(PROD)([x_pilastri3,y_pilastri3,QUOTE([-0,2])])
pilastri3 = T(3)(-1)(pilastri3)


VIEW(STRUCT([COLOR(CYAN)(vetrata), COLOR(BROWN)(pilastri), COLOR(BROWN)(pilastri3), COLOR(BROWN)(tetto), scala, COLOR(BROWN)(seminterrato)]))